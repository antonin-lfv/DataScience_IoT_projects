...
[![Code source](https://img.shields.io/badge/Code_source-000?logo=Visual+Studio+Code)](https://github.com/antonin-lfv/ESP32-robot-piloting-with-TinySpeech) &nbsp; [![ElioBot](https://img.shields.io/badge/ElioBot-FFF?logo=Probot&logoColor=594D9B)](https://eliobot.com) &nbsp; [![ESP32](https://img.shields.io/badge/ESP32-FFF?logo=esphome&logoColor=000)]() &nbsp; [![PyTorch](https://img.shields.io/badge/PyTorch-FFF?logo=pytorch)]() &nbsp; [![Streamlit](https://img.shields.io/badge/Streamlit-FFF?logo=streamlit)]()
